...
userRoutes.get("/credit", classicAuthMiddleware, userController.creditMoney)
userRoutes.get("/debite", classicAuthMiddleware, userController.debiteMoney)
userRoutes.get("/mytransaction", classicAuthMiddleware, userController.getMyTransaction)
